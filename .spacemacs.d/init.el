...
values." ;; This setq-default sexp is an exhaustive list of all the supported ;; spacemacs settings.
  (setq-default
...
layers configuration. You are free to put any user code."
   ...
   (spacemacs//set-monospaced-font "Droid Sans Mono for Powerline" "Microsoft YaHei" 17 18)
